...
export default class OrbitControls {
  ...
  addEvents() {
    if (this.rotate) {
      this.parent.addEventListener('mousedown', this.onInputDown, { passive: false })
      this.parent.addEventListener('mousemove', this.onInputMove, { passive: false })
      this.parent.addEventListener('mouseup', this.onInputUp, { passive: false })
    }

    if (this.zoom) {
      mouseWheel(this.element, this.handleZoom, true)
    }
  }

  removeEvents() {
    this.parent.removeEventListener('mousedown', this.onInputDown, { passive: false })
    this.parent.removeEventListener('mousemove', this.onInputMove, { passive: false })
    this.parent.removeEventListener('mouseup', this.onInputUp, { passive: false })
  }
